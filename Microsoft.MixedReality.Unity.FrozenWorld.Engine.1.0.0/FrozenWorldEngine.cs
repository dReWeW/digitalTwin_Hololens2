...
namespace Microsoft.MixedReality.FrozenWorld.Engine
{
    public unsafe static class Engine
    {
        ...
        // Version
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_GetVersion([MarshalAs(UnmanagedType.U1)] bool detail, int versionBufferSize, byte* versionOut);

        // Errors and diagnostics
        [DllImport("FrozenWorldPlugin")] [return: MarshalAs(UnmanagedType.U1)] public static extern bool FrozenWorld_GetError();
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_GetErrorMessage(int messageBufferSize, byte* messageOut);

        // Startup and tear down
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Init();
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Destroy();

        // Alignment
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Step_Init();
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_Step_GatherSupports();
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Step_AlignSupports();

        // Alignment configuration
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_GetAlignConfig(FrozenWorld_AlignConfig* configOut);
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_SetAlignConfig(FrozenWorld_AlignConfig* config);

        // Supports access
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_GetNumSupports();
        ...
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_GetHead(FrozenWorld_Snapshot snapshot, FrozenWorld_Vector* headPositionOut, FrozenWorld_Vector* headDirectionForwardOut, FrozenWorld_Vector* headDirectionUpOut);
        ...
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_GetAlignment(FrozenWorld_Transform* spongyFromFrozenTransformOut);
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_SetAlignment(FrozenWorld_Transform* spongyFromFrozenTransform);

        // Snapshot access: Most significant anchor
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_GetMostSignificantAnchorId(FrozenWorld_Snapshot snapshot, FrozenWorld_AnchorId* anchorIdOut);
        ...
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_GetNumAnchors(FrozenWorld_Snapshot snapshot);
        ...
        [DllImport("FrozenWorldPlugin")] [return: MarshalAs(UnmanagedType.U1)] public static extern bool FrozenWorld_RemoveAnchor(FrozenWorld_Snapshot snapshot, FrozenWorld_AnchorId anchorId);
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_ClearAnchors(FrozenWorld_Snapshot snapshot);

        // Snapshot access: Edges
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_GetNumEdges(FrozenWorld_Snapshot snapshot);
        ...
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_MergeAnchorsAndEdges(FrozenWorld_Snapshot sourceSnapshot, FrozenWorld_Snapshot targetSnapshot);
        ...
        // Metrics
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_GetMetrics(FrozenWorld_Metrics* metricsOut);

        // Metrics configuration
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_GetMetricsConfig(FrozenWorld_MetricsConfig* configOut);
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_SetMetricsConfig(FrozenWorld_MetricsConfig* config);

        // Scene object tracking
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Tracking_CreateFromHead(FrozenWorld_Vector* frozenLocation, FrozenWorld_AttachmentPoint* attachmentPointOut);
        ...
        // Fragment merge
        [DllImport("FrozenWorldPlugin")] [return: MarshalAs(UnmanagedType.U1)] public static extern bool FrozenWorld_RefitMerge_Init();
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_RefitMerge_Prepare();
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_RefitMerge_Apply();

        // Fragment merge: Adjustments query
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_RefitMerge_GetNumAdjustedFragments();
        ...
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_RefitMerge_GetAdjustedAnchorIds(FrozenWorld_FragmentId fragmentId, int adjustedAnchorIdsBufferSize, FrozenWorld_AnchorId* adjustedAnchorIdsOut);
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_RefitMerge_GetMergedFragmentId(FrozenWorld_FragmentId* mergedFragmentIdOut);

        // Refreeze
        [DllImport("FrozenWorldPlugin")] [return: MarshalAs(UnmanagedType.U1)] public static extern bool FrozenWorld_RefitRefreeze_Init();
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_RefitRefreeze_Prepare();
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_RefitRefreeze_Apply();

        // Refreeze: Adjustments query
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_RefitRefreeze_GetNumAdjustedFragments();
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_RefitRefreeze_GetNumAdjustedAnchors();
        ...
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_RefitRefreeze_GetAdjustedAnchorIds(int adjustedAnchorIdsBufferSize, FrozenWorld_AnchorId* adjustedAnchorIdsOut);
        [DllImport("FrozenWorldPlugin")] [return: MarshalAs(UnmanagedType.U1)] public static extern bool FrozenWorld_RefitRefreeze_CalcAdjustment(FrozenWorld_AttachmentPoint* attachmentPointInOut, FrozenWorld_Transform* objectAdjustmentOut);
        ...
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Serialize_Open(FrozenWorld_Serialize_Stream* streamInOut);
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Serialize_Gather(FrozenWorld_Serialize_Stream* streamInOut);
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_Serialize_Read(FrozenWorld_Serialize_Stream* streamInOut, int bytesBufferSize, byte* bytesOut);
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Serialize_Close(FrozenWorld_Serialize_Stream* streamInOut);

        // Persistence: Deserialization
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Deserialize_Open(FrozenWorld_Deserialize_Stream* streamInOut);
        [DllImport("FrozenWorldPlugin")] public static extern int FrozenWorld_Deserialize_Write(FrozenWorld_Deserialize_Stream* streamInOut, int numBytes, byte* bytes);
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Deserialize_Apply(FrozenWorld_Deserialize_Stream* streamInOut);
        [DllImport("FrozenWorldPlugin")] public static extern void FrozenWorld_Deserialize_Close(FrozenWorld_Deserialize_Stream* streamInOut);
    }
}
